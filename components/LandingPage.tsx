  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <header className="border-b border-slate-700/50 bg-slate-900/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 lg:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-white">MaddenBet Pro</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-emerald-600/20 text-emerald-400 border-emerald-600/30">Next-Gen CFM Betting</Badge>
      ...
      <section id="features" className="py-20 bg-slate-800/50">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center space-y-4 mb-16">
            <Badge className="bg-blue-600/20 text-blue-400 border-blue-600/30">Features</Badge>
            <h2 className="text-3xl lg:text-5xl font-bold text-white">Everything You Need to Dominate</h2>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center space-y-4 mb-16">
            <Badge className="bg-emerald-600/20 text-emerald-400 border-emerald-600/30">Pricing</Badge>
            <h2 className="text-3xl lg:text-5xl font-bold text-white">Choose Your Game Plan</h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-slate-800/50">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center space-y-4 mb-16">
            <Badge className="bg-blue-600/20 text-blue-400 border-blue-600/30">Contact</Badge>
        ...
        <div className="container mx-auto px-4 lg:px-6 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="text-lg font-bold text-white">MaddenBet Pro</span>
            </div>
